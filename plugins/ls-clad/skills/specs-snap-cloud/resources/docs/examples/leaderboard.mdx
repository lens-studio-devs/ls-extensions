...
Set up your project as per the [Getting Started](https://developers.snap.com/spectacles/about-spectacles-features/snap-cloud/getting-started) guide before proceeding. For full reference documentation, see the [Snap Cloud documentation site](https://cloud.snap.com/docs).
