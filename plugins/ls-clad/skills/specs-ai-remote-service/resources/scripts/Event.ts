...
/**
 * Specs Inc. 2026
 * Generic event system with typed arguments. Provides a pub-sub pattern for managing event
 * handlers with type safety, supporting add, remove, invoke, and public API functionality.
 */
