...
This sample project is available on the [Lens Studio Home Page](https://developers.snap.com/lens-studio/lens-studio-workflow/lens-studio-interface/home).
...
> Follow the instructions at [Remote Service Gateway](https://developers.snap.com/spectacles/about-spectacles-features/apis/remoteservice-gateway) to get a gateway credential. Enter this in the SceneObject **RemoteServiceGatewayCredentials**.
...
> See [Spatial Image Angle Validator](https://developers.snap.com/spectacles/about-spectacles-features/apis/spatial-image#spatial-image-angle-validator) in the upstream docs for a diagram of the valid-zone geometry.
