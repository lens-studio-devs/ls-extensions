...
> Upstream docs for figures and diagrams: [Sync Transform](https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-sync-kit/features/sync-transform).
