...
> Upstream docs for figures and diagrams: [Lifecycle](https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-sync-kit/lifecycle).
...
> See [Session Setup Flowchart](https://developers.snap.com/spectacles/spectacles-frameworks/spectacles-sync-kit/lifecycle#session-setup-flowchart) in the upstream docs for diagrams.
