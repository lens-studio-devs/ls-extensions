...
bool register_export(CoreJsAbiRuntime* runtime,
    ...
    CoreJsAbiFunctionOrError functionOrError =
        runtime->vt->create_function_from_host_function(runtime, wrappedFunction.release());
    ...
    CoreJsAbiValue functionAsAbiValue{
        .kind = CoreJsAbiValueKindObject, .data = {.pointer = functionOrError.ptr_or_error.ptr}};
    runtime->vt->set_object_property_from_string(
